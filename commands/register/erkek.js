...
module.exports.run = async (client, message, args) => {
  ...
  let embed = new MessageEmbed()
    ...
    .setDescription(`**<a:oany:798979366570033252> Kayıt işlemi başarılı. ${user} Sana <@&795313354054172747> Rölünü verdim. \n Ve adını \`${name.replace("_", " ")} | ${age}\` olarak değiştirdim.**
